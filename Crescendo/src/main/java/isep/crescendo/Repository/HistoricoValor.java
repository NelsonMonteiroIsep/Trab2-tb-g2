...
public class HistoricoValor {
    ...
    public List<isep.crescendo.model.HistoricoValor> listarPorCripto(int criptoId) {
        List<isep.crescendo.model.HistoricoValor> lista = new ArrayList<>();
        ...
        try (Connection conn = getConnection();
            ...
            while (rs.next()) {
                isep.crescendo.model.HistoricoValor hv = new isep.crescendo.model.HistoricoValor();
